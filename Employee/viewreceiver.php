    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="title"><p>Receiver</p>
                    <form class="form-search" method="get" action="">

<input type="search" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" placeholder="Enter Receiver Id">
<button type="submit" name="submit">Search</button>

</form>
                    </div>
                    <div class="col-sm-7">
                        <a href="addreceiver.php" class="btn btn-secondary"><span>Add New Receiver</span></a>
                    </div>
                </div>
            </div>
                ...
                <?php 
                    if (isset($_GET['submit'])) {
                        if($_GET['search']==null){
                            ...
                            $query="SELECT * FROM `receiver` WHERE Rid='$search_query'";
                        }
                    }
                    else{
                        $query="SELECT * FROM `receiver`";
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['Rcno']; ?></td>
                        <td><?php echo $data['Rcity']; ?></td>
                        <td><?php echo $data['Remail']; ?></td>
                        <td><?php echo $data['Radd']; ?></td>
                        <td><?php echo $data['Rpin']; ?></td>
                        <td style="width: 200px; padding:0px;">
                            <a href="editreceiver.php?id=<?php echo $data['Rid']; ?>">
                            ...
                            <a href="deletereceiver.php?id=<?php echo $data['Rid']; ?>">
