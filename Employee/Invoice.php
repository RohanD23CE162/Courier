					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-sm-6 top-right">
								<h3 class="marginright">INVOICE-<?php echo $data['Pid'];?></h3>
								<span class="marginright"><?php echo $data['Date'];?></span>
							</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-xs-4 from">
								<p class="lead marginbottom">From : <?php echo $data1['Sname'];?></p>
								<p><?php echo $data1['Sadd'];?></p>
								<p><?php echo $data1['Scity'];?>, <?php echo $data1['Spin'];?></p>
								<p>Phone: <?php echo $data1['Scno'];?></p>
								<p>Email: <?php echo $data1['Semail'];?></p>
							...
							<div class="col-xs-4 to">
								<p class="lead marginbottom">To : <?php echo $data2['Rname'];?></p>
								<p><?php echo $data2['Radd'];?></p>
								<p><?php echo $data2['Rcity'];?>, <?php echo $data2['Rpin'];?></p>
								<p>Phone: <?php echo $data2['Rcno'];?></p>
								<p>Email: <?php echo $data2['Remail'];?></p>
								<!-- <p>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
							...
							<div class="col-xs-4 text-right payment-details">
								...
								<p>VAT: DK888-777 </p>
								<p>Total Amount: <?php echo $data['Price'];?></p>
							...
							<table class="table table-striped">
								...
								<tbody>
									<tr>
										...
										<td class="text-right"><?php echo $data['Weight'];?></td>
						...
						<div class="row">
							<div class="col-xs-6 margintop">
								...
								<button class="btn btn-success"><i class="fa fa-print"></i> Print Invoice</button>	
									<button class="btn btn-success" name="back"><i class="fa fa-backward"></i>back</button></form>
							</div>
						</div>
					</div>
				</div>
